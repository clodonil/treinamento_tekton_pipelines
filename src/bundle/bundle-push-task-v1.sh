...
tkn bundle push index.docker.io/clodonil/task-exemplo1:v1 -f task-exemplo1-v1.yaml
tkn bundle push index.docker.io/clodonil/task-exemplo1:latest -f task-exemplo1-v1.yaml
